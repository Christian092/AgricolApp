...
namespace ProyectoV1.Helpers
{
    public static class QRHelper
    {
        ...
        public static IHtmlString GenerateQrCode2(this HtmlHelper html, string url, string alt = "QR code", int height = 400, int width = 400, int margin = 0)
        {
            var qrWriter = new BarcodeWriter();
            qrWriter.Format = BarcodeFormat.QR_CODE;
            qrWriter.Options = new EncodingOptions() { Height = height, Width = width, Margin = margin };
        ...
        public static IHtmlString GenerateQrCode3(this HtmlHelper html, string url, string alt = "QR code", int height = 42, int width = 42, int margin = 0)
        {
            var qrWriter = new BarcodeWriter();
            qrWriter.Format = BarcodeFormat.QR_CODE;
            qrWriter.Options = new EncodingOptions() { Height = height, Width = width, Margin = margin };
